package com.sange.easy.json.gson;
...
class GsonTools {
    ...
    public static String errorTrack(JsonReader in, String type) {
        ...
        for (StackTraceElement element : stackTrace) {
            stringBuilder.append(element.getClassName()).append(".").append(element
                    .getMethodName()).append("(").append(element
                    .getLineNumber()).append(")\n");
        }
        try {
            stringBuilder.append("Expected a ").append(type).append(" but was ").append(in.peek()).append(" path ").append(in
                    .getPath());
