...
constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        if (null == SwipeBackConfig.content) {
            // 加载显示图片
            SwipeBackConfig.content = ContextCompat.getDrawable(
                getContext(),
                R.drawable.ic_swipe_arrow_left_gray
            )
        }
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        val iWidth =
            (SwipeBackConfig.dragWidth * mProgress + paddingStart + paddingEnd).roundToInt()
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val tranY: Float =
            (height - getValueByLine(
                height.toFloat(),
                SwipeBackConfig.targetHeight.toFloat(),
                mProgress
            )) / 2
    ...
    private fun updatePathLayout() {
        ...
        // 角度转弧度
        val angle =
            SwipeBackConfig.tangentAngle * mTangentAngleInterpolator.getInterpolation(progress)
